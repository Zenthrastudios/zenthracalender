    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12 relative z-10">
        <div className="w-full max-w-md animate-fade-in">
          ...
          <div className="bg-card/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-8">
            {/* Google Auth Button */}
            <button
              onClick={handleGoogleAuth}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-background/50 hover:bg-background/80 rounded-xl transition-all border border-border hover:border-primary/50 shadow-sm hover:shadow-md"
            >
            ...
            <div className="flex items-center gap-4 my-6">
              ...
              <span className="text-sm text-muted-foreground uppercase text-xs font-bold tracking-wider">or email</span>
              <div className="flex-1 h-px bg-border/50"></div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full h-12 rounded-xl text-base shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all font-semibold"
                disabled={isLoading}
              >
                {isLoading ? (
