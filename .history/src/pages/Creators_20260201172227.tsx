    ...
    return (
        <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-orange-100">
            ...
            <section className="pt-24 pb-16 px-6 text-center">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="text-xl text-slate-500 font-medium leading-relaxed max-w-2xl mx-auto">
                        Join 50,000+ top creators who have moved their entire business to Zenthra for 3x more conversions.
                    </p>
                </div>
            </section>
                        ...
                        <div key={i} className="group p-8 rounded-[3.5rem] bg-slate-50 border-2 border-slate-50 hover:border-orange-200 transition-all hover:bg-white hover:shadow-2xl hover:shadow-orange-100">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="relative pt-6 border-t border-slate-200/60">
                                    <Quote className="absolute top-4 -left-2 w-8 h-8 text-orange-200 opacity-50 quote-icon" />
            ...
            <section className="py-24 px-6 lg:px-20">
                <div className="rounded-[4rem] bg-slate-900 text-white p-12 lg:p-24 relative overflow-hidden flex flex-col items-center text-center">
                    ...
                    <p className="text-xl text-slate-400 font-medium mb-12 max-w-2xl">
                        Most creators lose 70% of potential sales due to clunky checkout flows. Zenthra fixes that overnight.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-6">
                        <Button size="xl" className="rounded-full bg-orange-600 hover:bg-orange-700 text-white px-12 h-16 text-xl font-black transition-all active:scale-95 shadow-xl shadow-orange-900/40">
                            <Link to="/auth">Start Your Journey</Link>
                        </Button>
                        <Button size="xl" variant="outline" className="rounded-full bg-transparent border-white/20 hover:bg-white/10 text-white px-12 h-16 text-xl font-black transition-all active:scale-95">
                            Explore Features
                        </Button>
                    </div>
                </div>
