...
export default function Features() {
    return (
        <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-orange-100">
            ...
            <section className="pt-24 pb-16 px-6 text-center bg-slate-50">
                <div className="max-w-3xl mx-auto">
                    ...
                    <p className="text-xl text-slate-500 font-medium leading-relaxed">
                        Stop juggling 10 different apps. Zenthra integrates everything from <br className="hidden md:block" /> booking to sales and automation in one clean interface.
                    </p>
                </div>
            </section>
                    ...
                    {FEATURES_LIST.map((feature, i) => (
                        <div key={i} className={`grid lg:grid-cols-2 gap-20 items-center ${i % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
                            <div className={`space-y-8 ${i % 2 !== 0 ? 'lg:order-2' : ''}`}>
                                <div className="w-16 h-16 rounded-2xl bg-orange-600 flex items-center justify-center shadow-xl shadow-orange-100">
