...
export default function CourseViewer() {
    ...
    // iOS Safari has CORS issues with streaming endpoints, use direct video URL as primary for iOS
    const videoStreamUrl = currentLesson?.id && accessToken && !isIOS
        ? `${SUPABASE_FN_URL}?lessonId=${currentLesson.id}&token=${accessToken}`
        : currentLesson?.video_url || null; // Use direct URL for iOS or as fallback
